...
def format_with_claude(articles, prices, fear_greed, test=False):
    ...
    prompt += "5. Every bullet must include historical context - what happened last time this pattern appeared\n"
    ...
    prompt += "   Use exactly: '🟢 Bullish' or '🔴 Bearish' or '🟡 Neutral'\n"
    prompt += "8. No URLs, no source names, no markdown\n"
    prompt += "9. Crypto: ONLY write about Bitcoin (BTC) and Ethereum (ETH) price action, ETF inflows, or major regulation. Never mention DeFi protocols, altcoins, or obscure projects.\n"
    ...
    prompt += "14. Key Level: add ONE specific price level that is most important to watch today. Format example: 'BTC $72,000 - breaks below this and next stop is $65k' or 'Oil $100 - if this breaks, inflation spikes globally'. Make it the most actionable line in the post.\n\n"
    prompt += "Articles:\n" + articles_text + "\n"

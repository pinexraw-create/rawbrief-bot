...
def format_with_claude(articles, prices, fear_greed_value, fear_greed_class, test=False):
    ...
    prompt += "-> Oil crashed 9% as Hormuz reopens. Last 3 times this fast - stocks rallied 8% in 30 days. Smart money already rotating.\n"
...
def generate_weekly_recap(prices, fear_greed_value, fear_greed_class):
    ...
    prompt += "ETH " + prices.get("ETH", "N/A") + "\n"
    prompt += "S&P 500 " + prices.get("SPX", "N/A") + "\n"

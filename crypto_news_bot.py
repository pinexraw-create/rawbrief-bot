...
def format_with_claude(articles, prices, fear_greed, test=False):
    ...
    prompt += "-> Central banks buying gold for 23 straight months. Not 2. Not 5. Twenty three. They know something. Ask yourself where this goes.\n"
    prompt += "-> Oil below $92. Check the last 3 times Hormuz tensions eased. Minus 15% in 30 days. The pattern is there.\n\n"
    ...
    prompt += "6. End each bullet with a short punchy line. Examples: What are you doing?, No exceptions so far., Fear is cheap., Ask yourself where this goes., The pattern is there.\n"
